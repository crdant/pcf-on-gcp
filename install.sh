...
service_broker () {
  ...
  set_networks_azs "gcp-service-broker" "${TILES_NETWORK_NAME}"
...
push_notifications () {
  ...
  set_networks_azs "${PUSH_SLUG}" "${TILES_NETWORK_NAME}"
}
