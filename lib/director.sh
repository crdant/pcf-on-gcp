...
; envsubst < api-calls/director/create-networks.json; unset SUBDOMAIN_TOKENT REGION_1 INFRASTRUCTURE_NETWORK_NAME DEPLOYMENT_NETWORK_NAME TILES_NETWORK_NAME SERVICES_NETWORK_NAME  DNS_SERVERS INFRASTRUCTURE_CIDR INFRASTRUCTURE_RESERVED INFRASTRUCTURE_GATEWAY DEPLOYMENT_CIDR DEPLOYMENT_RESERVED DEPLOYMENT_GATEWAY TILES_CIDR TILES_RESERVED TILES_GATEWAY SERVICES_CIDR SERVICES_RESERVED SERVICES_GATEWAY AVAILABILITY_ZONE_1 AVAILABILITY_ZONE_2 AVAILABILITY_ZONE_3`
echo $NETWORKS_JSON
