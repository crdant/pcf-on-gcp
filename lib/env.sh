...
env () {
  ...
  BUILDPACKS_STORAGE_LOCATION="buildpacks-pcf-${DOMAIN_TOKEN}"
  DROPLETS_STORAGE_LOCATION="droplets-pcf-${DOMAIN_TOKEN}"
  PACKAGES_STORAGE_LOCATION="packages-pcf-${DOMAIN_TOKEN}"
  RESOURCES_STORAGE_LOCATION="resources-pcf-${DOMAIN_TOKEN}"
